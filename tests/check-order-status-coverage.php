...
define('WHMCS', true);
require_once __DIR__ . '/../spectrocoin/lib/SCMerchantClient/Enum/OrderStatus.php';
...
$callbackSource = file_get_contents(__DIR__ . '/../callback/spectrocoin.php');

$t = new TestRunner();
echo "SpectroCoin WHMCS — order-status coverage\n\n";
